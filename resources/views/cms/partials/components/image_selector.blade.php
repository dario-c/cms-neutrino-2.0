<div class="form-group image-selector" id="{{ $postTypeField->id }}-image-selector">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <img class="image-preview" src="{{ asset('assets/cms/images/placeholders/image.png') }}" width="110" height="110" alt="preview" />
            
            <blockquote class="pull-left">
                <p><button type="button" class="btn btn-default" data-toggle="modal" data-target="#image-select-modal" selector="{{ $postTypeField->id }}-image-selector">Select image</button></p>
                <footer>
